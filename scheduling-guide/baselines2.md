...
title: "Developing a baseline schedule3"
description: "How t"
icon: "recycle"
...
Another way to show Finish-to-Start is negative lag. Negative lag is frowned upon, but it is okay as long as you do not have giant lag numbers. The risk is that the predecessor will not be fully complete before you start the next activity.
...
![](images/dcma-14-schedule-quality.png)
...
![](images/schedule-quality-cheat-sheet.png)
